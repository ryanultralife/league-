// Diamond Overlay service worker.
// Goal: make the app installable and keep the shell available offline so a
...
const SHELL = ['/', '/stream', '/controller', '/lineup', '/manifest.json'];
